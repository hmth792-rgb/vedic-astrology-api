...
def _format_refined_d10_response(d10_data: dict) -> dict:
    """Format D10 data into refined response with essential graha information only."""
    ...
    return {
        ...
        "description": d10_data.get("description", "Divisional chart for career, profession, and status"),
        "lagna": {
            "longitude": format_longitude(lagna.longitude, lagna.sign),
            "sign": f"{lagna_sign_eng} ({lagna_sign_sans})",
            "degree_in_sign": lagna.degree,
        },
        "ayanamsa": d10_data['ayanamsa'],
