...
def _format_refined_d4_response(d4_data: dict) -> dict:
    """Format D4 data into refined response with essential graha information only."""
    ...
    return {
        ...
        "description": d4_data.get("description", "Divisional chart for property, fixed assets, and material foundations"),
        "lagna": {
            "longitude": format_longitude(lagna.longitude, lagna.sign),
            "sign": f"{lagna_sign_eng} ({lagna_sign_sans})",
            "degree_in_sign": lagna.degree,
        },
        "ayanamsa": d4_data['ayanamsa'],
