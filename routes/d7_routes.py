...
def _format_refined_d7_response(d7_data: dict) -> dict:
    """Format D7 data into refined response with essential graha information only."""
    ...
    return {
        ...
        "description": d7_data.get("description", "Divisional chart for children and progeny"),
        "lagna": {
            "longitude": format_longitude(lagna.longitude, lagna.sign),
            "sign": f"{lagna_sign_eng} ({lagna_sign_sans})",
            "degree_in_sign": lagna.degree,
        },
        "ayanamsa": d7_data['ayanamsa'],
