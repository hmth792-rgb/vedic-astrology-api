...
def _format_refined_d6_response(d6_data: dict) -> dict:
    """Format D6 data into refined response with essential graha information only."""
    ...
    return {
        ...
        "description": d6_data.get("description", "Divisional chart for health, diseases, and enemies"),
        "lagna": {
            "longitude": format_longitude(lagna.longitude, lagna.sign),
            "sign": f"{lagna_sign_eng} ({lagna_sign_sans})",
            "degree_in_sign": lagna.degree,
        },
        "ayanamsa": d6_data['ayanamsa'],
